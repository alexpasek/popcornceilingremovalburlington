...
export const metadata = { title: "North York — Wallpaper Removal Pro" };
  ...
  return (
    <div className="container-x py-10">
      ...
      <nav className="text-sm text-gray-500 mb-6">
        <Link href="/">Home</Link> / North York
      </nav>
      <h1 className="text-3xl font-bold">
        North York — Wallpaper, Popcorn Ceiling, Drywall & Painting
      </h1>
      <p className="mt-2 text-gray-700">
        Trusted contractor for wallpaper removal, dust‑free popcorn ceiling
        removal, drywall installation & repair, and interior painting in North
        York.
      </p>
