...
export const metadata = { title: "Milton — Wallpaper Removal Pro" };
  ...
  return (
    <div className="container-x py-10">
      ...
      <nav className="text-sm text-gray-500 mb-6">
        <Link href="/">Home</Link> / Milton
      </nav>
      <h1 className="text-3xl font-bold">
        Milton — Wallpaper, Popcorn Ceiling, Drywall & Painting
      </h1>
      <p className="mt-2 text-gray-700">
        Trusted contractor for wallpaper removal, dust‑free popcorn ceiling
        removal, drywall installation & repair, and interior painting in Milton.
      </p>
      <p className="mt-1 text-sm">
        Official site:{" "}
        <a
          className="underline"
          href="https://www.milton.ca/"
          target="_blank"
          rel="noopener"
        >
          https://www.milton.ca/
