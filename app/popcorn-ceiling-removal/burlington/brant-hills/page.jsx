    ...
    <div className="container-x mx-auto px-4 py-10">
      ...
      <section id="process" className="mt-10">
        ...
        <ol className="mt-3 list-decimal pl-5 space-y-2 text-gray-700 max-w-3xl">
          ...
          <li>Full-field skim for Level 4–5 finish.</li>
          <li>HEPA sanding; raking-light QA and touch-ups.</li>
          <li>Stain-block primer for uniformity and sheen control.</li>
          <li>Optional: finish paint (two coats).</li>
        </ol>
      </section>
      ...
      <section id="pricing" className="mt-10">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-white rounded-2xl border shadow-sm">
            ...
            <ul className="mt-2 text-gray-700 list-disc pl-5 space-y-1">
              ...
              <li>Hallways + landings</li>
              <li>Family room + dining combinations</li>
            </ul>
          </div>
          <div className="p-4 bg-white rounded-2xl border shadow-sm">
            ...
            <ul className="mt-2 text-gray-700 list-disc pl-5 space-y-1">
              ...
              <li>smooth ceilings Brant Hills</li>
              <li>Level 5 finish Burlington</li>
        ...
        <p className="mt-4 text-gray-700 max-w-4xl">
          Painted texture, ceiling repairs, and Level 5 finishing add scope;
          materials & HST are separate. Share sizes for a firm quote.
        </p>
      </section>
      ...
      <section id="local" className="mt-10">
        ...
        <p className="mt-3 text-gray-700 max-w-5xl">
          ...
          <strong>Hwy 407</strong>. Our <strong>Level 5 skim</strong> keeps big
          rooms looking flat even under raking light from large windows.
        </p>
