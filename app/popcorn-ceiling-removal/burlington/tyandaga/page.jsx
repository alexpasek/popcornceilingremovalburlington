      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "On request, yes. Level 5 adds a tight skim and polish—ideal for strong lighting and long ceiling runs.",
            },
          },
        ],
      },
    ...
    <div className="container-x mx-auto px-4 py-10">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-3 text-gray-700 max-w-3xl">
              ...
              , tight <strong>Level 4–5 skims</strong>, stain-block primer, and
              clean finish paint.
            </p>
          </div>
      ...
      <section id="why-us" className="mt-10">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-5 bg-white rounded-2xl border shadow-sm">
            ...
            <p className="mt-2 text-gray-700">
              Photo sizes → written quote → fixed start date. Insured, pro crews
      ...
      <section id="process" className="mt-10">
        ...
        <ol className="mt-3 list-decimal pl-5 space-y-2 text-gray-700 max-w-3xl">
          ...
          <li>Skim full-field to Level 4–5 as required.</li>
