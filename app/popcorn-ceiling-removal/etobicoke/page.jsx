...
export const metadata = {
  ...
  alternates: {
    canonical: "/popcorn-ceiling-removal/etobicoke/",
  },
  openGraph: {
    ...
    url: "/popcorn-ceiling-removal/etobicoke/",
    type: "article",
  },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: "Etobicoke",
            item: "/popcorn-ceiling-removal/etobicoke/",
          },
        ],
      },
    ],
      ...
      <section id="neighborhoods" className="mt-10">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {hoods.map((n) => (
            <Link
              key={n.slug}
              href={`/popcorn-ceiling-removal/etobicoke/${n.slug}/`}
              className="pill"
            >
              {n.name}
            </Link>
