...
export const metadata = {
  ...
  alternates: { canonical: "/popcorn-ceiling-removal/milton/" },
  openGraph: {
    ...
    url: "/popcorn-ceiling-removal/milton/",
    type: "article",
  },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: "Milton",
            item: "/popcorn-ceiling-removal/milton/",
          },
        ],
      },
    ],
      ...
      <section id="neighborhoods" className="mt-10">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {hoods.map((n) => (
            <Link
              key={n.slug}
              href={`/popcorn-ceiling-removal/milton/${n.slug}/`}
              className="pill"
            >
              {n.name}
            </Link>
