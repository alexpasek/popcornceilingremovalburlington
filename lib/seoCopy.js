...
// ===== WALLPAPER • CITY COPY (used by //[city]//) =====
export function buildCityCopy(citySlug) {
  ...
  var MAP = {
    toronto: {
      opening:
        "Wallpaper removal in {CITY}: clean adhesive wash, drywall touch-ups or skim, and a smooth, paint-ready finish that holds up under strong window light.",
      housing:
        "Condos and houses—sealed rooms, corridor protection, and tidy daily wrap-ups so life continues during the job in {CITY}.",
      trust:
        "Clear scope & schedule, WSIB + liability, and a written warranty. Photo updates so you always know progress.",
    },
    mississauga: {
      opening:
        "Wallpaper removal in {CITY}: enzyme or steam removal (method-tested), full glue wash, Level 4/5 skim where needed, prime and paint-ready.",
      housing:
        "Condo-friendly workflow: elevator bookings, quiet hours, and hallway protection. Family homes kept clean with containment and vent masking.",
      trust:
        "Fast photo estimates, predictable schedule, and a workmanship warranty—no surprises.",
    },
    oakville: {
      opening:
        "Wallpaper removal in {CITY}: careful strip, adhesive fully removed, skim as needed, prime for a premium paint finish.",
      housing:
        "Large windows and long sightlines mean we check surfaces in critical light for a truly smooth read.",
      trust:
        "Insured & WSIB. Clean site, on-time handover, and written warranty.",
    },
  ...
  var fallback = {
    opening:
      "Wallpaper removal in {CITY}: safe stripping, full adhesive wash, drywall repairs/skim where needed, primer and a paint-ready surface.",
    housing:
      "We protect floors & vents, seal rooms, and keep your {CITY} home or condo clean throughout.",
    trust:
      "Clear scope, reliable schedule, and a written warranty—plus photo updates for transparency.",
  };
...
export function buildPopcornCopy(citySlug) {
  ...
  var CITY_MAP = {
    toronto: {
      opening:
        "Toronto homes—from High Park semis to Bay Street condos—need a true Level 5 smooth to survive strong window light and long hallway sightlines.",
      housing:
        "Condos and houses in {CITY} get dust-contained work: sealed rooms, corridor protection, and vacuum-assist sanding so life carries on during the job.",
      trust:
        "Clear scope, on-time schedule, WSIB + liability, and a 3-year workmanship warranty. Daily photo updates for full transparency.",
      recent:
        "Recent in {CITY}: Etobicoke 1960s bungalow—painted popcorn with new pot lights. Encapsulation, Level 5 skim, prime & sprayed ceiling white.",
      review:
    ...
    mississauga: {
      opening:
        "In {CITY}, Port Credit condos and Lorne Park homes often have multiple paint layers on texture—best handled with controlled scrape or safe encapsulation.",
      housing:
        "We isolate rooms, mask vents, and deliver a bright, uniform ceiling that reads flat in {CITY} daylight.",
      trust:
        "Fast photo estimate, tidy crew, and a clean handover. WSIB + liability coverage with a 3-year workmanship warranty.",
      recent:
        "Recent in {CITY}: Erin Mills two-storey—scrape + Level 5 skim in living/dining; paint-ready in 3 days.",
      review:
        "“Dust control was excellent and schedule exact.” — S., Erin Mills",
      usp: [
        [
          "Minimal disruption",
    ...
    oakville: {
      opening:
        "Big windows and critical light in {CITY} make Level 5 finishing essential so ceilings look premium and perfectly flat.",
      housing:
        "We repair pot-light cutouts and water stains, then skim, prime and leave a paint-ready ceiling for your {CITY} home.",
      trust:
        "Insured & WSIB. 3-year warranty. Clean daily wrap-ups so the house stays functional.",
      recent:
        "Recent in {CITY}: Bronte detached—water-stain repair, full skim, prime & flat finish.",
    ...
    burlington: {
      opening:
        "Open-concept spaces in {CITY} expose ceiling flaws—our Level 5 skim erases waves and joint telegraphing for a clean, upscale look.",
      housing:
        "Condo-friendly: elevator bookings, hallway protection, and quiet hours observed.",
      trust:
        "Written scope, daily updates, WSIB + liability, and a 3-year warranty.",
      recent:
        "Recent in {CITY}: Downtown condo—night work, skim-coat, prime; zero corridor dust.",
      review:
        "“Condo rules respected, spotless cleanup.” — L., Downtown Burlington",
      usp: [
        [
          "Dust-controlled",
    ...
    milton: {
      opening:
        "{CITY} newer builds can show seam telegraphing—our Level 5 system flattens joints before bright whites go on.",
      housing:
        "We protect stairs and floors, isolate areas, and keep families moving through the home during the project.",
      trust:
        "Clear pricing, predictable schedule, insured & WSIB, with a 3-year warranty.",
      recent:
        "Recent in {CITY}: Scott area loft—hall ceilings leveled and repainted for uniform sheen.",
    ...
    hamilton: {
      opening:
        "Character homes in {CITY} need careful containment and a full Level 5 skim to modernize ceilings without mess.",
      housing:
        "We respect plaster quirks, blend patches from rewiring, and deliver a uniform, prime-ready surface.",
      trust: "Local crew, insured, WSIB, with a 3-year workmanship warranty.",
      recent:
        "Recent in {CITY}: Kirkendall semi—rewiring patches blended invisibly; ceilings repainted.",
    ...
    "stoney-creek": {
      opening:
        "Many {CITY} projects pair popcorn removal with new pot lights—our blend-to-match hides every cutout and patch.",
      housing:
        "Encapsulation for heavily painted texture; full skim for uniform reflectance in open areas.",
      trust: "Clear schedule, insured & WSIB, 3-year warranty.",
      recent:
        "Recent in {CITY}: Winona split-level—encapsulation + skim, prime, bright flat finish.",
    ...
    ancaster: {
      opening:
        "High stairwells and skylights in {CITY} demand meticulous skim-coat so critical light won’t reveal waves.",
      housing:
        "Scaffold setups, careful edge work at skylight returns, and a bright, even finish.",
      trust: "Insured, WSIB, 3-year warranty—clean daily wrap-ups.",
      recent:
        "Recent in {CITY}: Meadowlands—scaffold, skylight returns skimmed, prime & finish.",
    ...
    grimsby: {
      opening:
        "Daylight in {CITY} lakeside condos shows everything—our Level 5 skim keeps ceilings flat and consistent.",
      housing:
        "Condo-friendly workflow: evening shifts, corridor protection, and strict dust control.",
      trust: "WSIB + liability, 3-year warranty, reliable handovers.",
      recent:
        "Recent in {CITY}: Lakeside condo—night shift, skim + prime; zero corridor dust.",
    ...
    vaughan: {
      opening:
        "{CITY} homes in Maple, Woodbridge and Kleinburg often combine popcorn removal with repainting for a brighter, upscale look.",
      housing:
        "We repair fixture cutouts and seams, then skim and prime to a paint-ready finish.",
      trust: "Clear scope, insured & WSIB, 3-year workmanship warranty.",
      recent:
        "Recent in {CITY}: Kleinburg—painted popcorn, pot-light patching, sprayed ceiling white.",
    ...
    "richmond-hill": {
      opening:
        "Long hallways and big windows in {CITY} need a true Level 5 to prevent flashing and joint shadows.",
      housing:
        "We skim, re-check under critical light, and prime with stain blocker for a stable finish.",
      trust: "Insured & WSIB, daily updates, and a 3-year warranty.",
      recent:
        "Recent in {CITY}: Bayview Hill—main-floor skim & repaint after lighting upgrade.",
  ...
  var fallback = {
    opening:
      "Popcorn ceiling removal in {CITY}: dust-contained scrape or safe encapsulation, Level 5 skim-coat, prime & paint.",
    housing:
      "We protect floors & vents, set up containment, and keep your {CITY} home or condo clean throughout.",
    trust:
      "Clear scope, reliable schedule, and a written warranty—plus photo updates for transparency.",
    recent:
      "Recent in {CITY}: Level 5 skim, prime, paint-ready finish after lighting upgrade.",
...
export function buildPopcornHoodCopy(citySlug, hoodSlug) {
  ...
  var HOOD_MAP = {
    toronto: {
      "high-park": {
        intro:
          "In {HOOD}, {CITY}, strong window light highlights ceiling flaws—our Level 5 skim keeps surfaces flat with no joint shadows.",
        highlights: [
        ...
        recent:
          "Semi near Bloor West: encapsulation, Level 5 skim, prime & sprayed ceiling white.",
      },
      "the-beaches": {
        intro:
          "Lakeside light in {HOOD} shows every ripple—our process delivers a bright, uniform ceiling that reads perfectly flat.",
        highlights: [
        ...
        recent:
          "Detached east of Queen: scrape + skim in living/dining; finished in 3 days.",
      },
      annex: {
        intro:
          "Annex ceilings often mix old plaster and newer drywall—our hybrid approach protects heritage details while modernizing the surface.",
        highlights: [
        ...
        recent:
          "Victorian semi: mixed substrate leveled to a clean, contemporary finish.",
      },
      leaside: {
        intro:
          "Renovated {HOOD} homes need clean transitions—our Level 5 skim removes waves from additions meeting old rooms.",
        highlights: [
        ...
        recent:
          "Side-split: addition tie-in leveled, uniform prime, bright finish.",
      },
    },
    ...
    mississauga: {
      "port-credit": {
        intro:
          "{HOOD} condos demand quiet, clean work—elevator bookings, corridor protection, and vacuum-assist sanding keep neighbours happy.",
        highlights: [
      ...
      "lorne-park": {
        intro:
          "Large rooms and strong sun in {HOOD} call for true Level 5 to avoid waves and seams.",
        highlights: [
      ...
      "erin-mills": {
        intro:
          "Open sightlines in {HOOD} show every flat spot—our method keeps ceilings even end-to-end.",
        highlights: [
        ...
        recent:
          "Main floor: scrape + Level 5 skim in living/dining; 3-day turnaround.",
      },
      clarkson: {
        intro:
          "Mixed-age homes in {HOOD} often hide patched areas—our feathering makes repairs invisible.",
        highlights: [
        ...
        recent:
          "Split-level: patch blend, full skim, prime and ceiling re-paint.",
      },
    },
    ...
    oakville: {
      bronte: {
        intro:
          "With bright lake light, {HOOD} ceilings must be perfectly flat—our Level 5 skim removes waves and joint ghosting.",
        highlights: [
        ...
        recent:
          "Detached near the lake: water-stain repair, full skim, prime & finish.",
      },
      "glen-abbey": {
        intro:
          "Tall foyers in {HOOD} need safe staging and meticulous skim—no roller lap marks or flashing.",
        highlights: [
        ...
        recent:
          "Two-storey foyer: staged safely, skimmed, primed, bright finish.",
      },
      "river-oaks": {
        intro:
          "Renovation tie-ins in {HOOD} benefit from our full-field skim to erase seams across old and new drywall.",
        highlights: [
    ...
    burlington: {
      downtown: {
        intro:
          "Condos in {HOOD} favour quiet, dust-controlled work—our condo-friendly process keeps common areas clean.",
        highlights: [
        ...
        recent:
          "Downtown condo: night shift, skim + prime; zero corridor dust.",
      },
      aldershot: {
        intro:
          "Older {HOOD} homes show joint waves—our Level 5 skim flattens everything before paint.",
        highlights: [
      ...
      "the-orchard": {
        intro:
          "Open-concept rooms in {HOOD} demand consistent reflectance—no flashing or lap marks.",
        highlights: [
        ...
        recent:
          "Kitchen/living: scrape + Level 5 skim; premium prime & paint-ready.",
      },
    },
    ...
    milton: {
      scott: {
        intro:
          "Newer {HOOD} builds can show seam telegraphing—our Level 5 step eliminates joints under bright whites.",
        highlights: [
      ...
      "hawthorne-village": {
        intro:
          "Fast schedules in {HOOD} need tight coordination—our team delivers on time without dust.",
        highlights: [
      ...
      dempsey: {
        intro:
          "Bright kitchens in {HOOD} show imperfections—our Level 5 makes ceilings read perfectly smooth.",
        highlights: [
    ...
    hamilton: {
      westdale: {
        intro:
          "Character homes in {HOOD} need careful methods—encapsulation protects plaster where scraping risks damage.",
        highlights: [
      ...
      kirkendall: {
        intro:
          "Open sightlines in {HOOD} expose flaws—our Level 5 step removes joint telegraphing completely.",
        highlights: [
      ...
      durand: {
        intro:
          "Condos in {HOOD} benefit from our quiet, compliant workflow—neighbours barely notice the work.",
        highlights: [
    ...
    "stoney-creek": {
      "heritage-green": {
        intro:
          "Upgrades in {HOOD} often add pot lights—our blend-to-match hides every cutout.",
        highlights: [
      ...
      battlefield: {
        intro:
          "Older ceilings in {HOOD} need gentle methods—encapsulation avoids damaging substrates.",
        highlights: [
      ...
      winona: {
        intro:
          "Open areas in {HOOD} require consistent reflectance—our skim and prime system delivers it.",
        highlights: [
    ...
    ancaster: {
      meadowlands: {
        intro:
          "Tall spaces in {HOOD} need safe staging and meticulous skim—no ripples around skylights.",
        highlights: [
      ...
      "ancaster-heights": {
        intro:
          "Sunlit rooms in {HOOD} show everything—our Level 5 makes ceilings read perfectly flat.",
        highlights: [
      ...
      "parkview-heights": {
        intro:
          "Renovations in {HOOD} need uniform ceilings across old and new rooms—our full-field skim delivers it.",
        highlights: [
    ...
    grimsby: {
      "grimsby-on-the-lake": {
        intro:
          "Corridor-sensitive condos in {HOOD} require dust-free prep—our condo workflow keeps common areas clean.",
        highlights: [
      ...
      "dorchester-estates": {
        intro:
          "Natural light in {HOOD} reveals joint shadows—our full skim erases them.",
        highlights: [
      ...
      escarpment: {
        intro:
          "Open views in {HOOD} demand consistent reflectance—no flashing from roller marks.",
        highlights: [
    ...
    vaughan: {
      maple: {
        intro:
          "Modern renos in {HOOD} often add lighting—our blending makes cutouts vanish.",
        highlights: [
      ...
      woodbridge: {
        intro:
          "Large rooms in {HOOD} show imperfections—our full skim produces a high-end, even read.",
        highlights: [
      ...
      kleinburg: {
        intro:
          "{HOOD} homes benefit from a premium finish—our Level 5 system delivers gallery-flat ceilings.",
        highlights: [
    ...
    "richmond-hill": {
      "bayview-hill": {
        intro:
          "Long hallways in {HOOD} expose imperfections—our Level 5 skim keeps ceilings flat from end to end.",
        highlights: [
      ...
      jefferson: {
        intro:
          "Open areas in {HOOD} need uniform reflectance—our process removes waves and lap marks.",
        highlights: [
      ...
      "oak-ridges": {
        intro:
          "Sunlight in {HOOD} highlights roller patterns—sprayed ceilings give a premium, uniform look.",
        highlights: [
  ...
  var fallback = {
    intro:
      "Popcorn ceiling removal in {HOOD}, {CITY}: dust-contained workflow, Level 5 skim, prime & paint-ready finish.",
    highlights: [
